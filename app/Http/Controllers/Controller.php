...
class Controller extends BaseController{
    ...
    public function home(){
        ...
        return view('welcome', [
            ...
            'businesses' => $businesses ? $businesses->ads()->whereStatus(1)->whereNotNull('publish_at')->limit(4)->get() : collect([]),
            'franchises' => $franchises ? $franchises->ads()->whereStatus(1)->whereNotNull('publish_at')->limit(4)->get() : collect([]),

...
class VendorResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'picture'       => $this->picture ? asset('images/'.$this->picture) : '/assets/admin/images/noimage.webp',
            'logo'          => $this->seller ? asset('images/'.$this->seller->logo) : '/assets/admin/images/noimage.webp',

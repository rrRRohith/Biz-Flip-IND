                    ...
                    <div className="content-header">
                        <div className='row'>
                            ...
                            <div className='col-lg-6'>
                                ...
                                <Link className='btn btn-info text-end' href={route('admin.facilities.create')}> Create</Link>
                                </PermissionAllow>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <Tr key={facility.id} className="hover-primary">
                                                        ...
                                                        <Td>
                                                            ...
                                                            <PermissionAllow permission={'Facility Delete'}>
                                                                <button onClick={(e) => deleteFacility(facility)} className="btn btn-transparent p-2 px-3 border-0">

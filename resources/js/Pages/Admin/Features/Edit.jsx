...
export default function Create({ features_item, queryParams = null, auth }) {
    ...
    useEffect(() => {
        ...
        if (features_item.icon) {
            setImagePreview(features_item.icon);
        }
    }, [features_item.icon]);
    ...
    const handleSubmit = (e) => {
        ...
        post(route("admin.features.update", features_item.id));
    };
    ...
    return (
        <Authenticated
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Feature/Edit</h2>}
        >
                        ...
                        <div className='row'>
                            <div className='col-lg-6'>
                                <div className="d-flex flex-column">
                                    <h4 className="page-title"> Edit Feature</h4>

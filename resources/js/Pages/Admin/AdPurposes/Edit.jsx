...
export default function Create({ purpose_item, queryParams = null, auth }) {
    ...
    useEffect(() => {
        ...
        if (purpose_item.icon) {
            setImagePreview(purpose_item.icon);
        }
    }, [purpose_item.icon]);
    ...
    const handleSubmit = (e) => {
        ...
        post(route("admin.ad_purposes.update", purpose_item.id));
    };
    ...
    return (
        <Authenticated
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Ad Purpose/Edit</h2>}
        >
            <Head title="Ad Purpose Edit" />
                        ...
                        <div className='row'>
                            <div className='col-lg-6'>
                                <div className="d-flex flex-column">
                                    <h4 className="page-title"> Edit Ad Purpose</h4>
                                    <div className="d-inline-block align-items-center mt-2">
                                        <nav>
                                            <ol className="breadcrumb">
                                                <li className="breadcrumb-item"><Link href={route('admin.index')}><i className="bi bi-house"></i> Dashboard</Link></li>
                                                <PermissionAllow permission={'Facilities Listing'}>
                                                    <li className="breadcrumb-item" aria-current="page"><Link href={route('admin.ad_purposes.index')}>Ad Purpose</Link></li>
                                                </PermissionAllow>
                            ...
                            <div className="col-12">
                                <div className="box">
                                    <div className="box-body">
                                        ...
                                        <PermissionAllow permission={'Ad Purpose Edit'} message={true}>

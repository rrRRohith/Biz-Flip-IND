...
export default function Edit({ province_item, queryParams = null, auth, countries }) {
    ...
    useEffect(() => {
        ...
        if (province_item.image) {
            setImagePreview(province_item.image);
        }
    }, [province_item.image]);
    ...
    const handleSubmit = (e) => {
        ...
        post(route("admin.province.update", province_item.id));
    };
    ...
    return (
        <Authenticated
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Province/Edit</h2>}
        >
                        ...
                        <div className='row'>
                            <div className='col-lg-6'>
                                <div className="d-flex flex-column">
                                    <h4 className="page-title"> Edit Province</h4>
                            ...
                            <div className="col-12">
                                <div className="box">
                                    <div className="box-body">
                                        <PermissionAllow permission={'Province Edit'} message="true">

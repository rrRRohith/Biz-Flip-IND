...
export default function Create({ type_item, queryParams = null, auth }) {

    const { data, setData, post, errors, reset } = useForm({
        image: '',
        title: type_item.title || '',
        status: type_item.status = 'published' ? 1 : 0 || 1,
        position: type_item.position || '', _method: "PUT",
        remove_image: false,
        icon : type_item.icon
    });
    ...
    useEffect(() => {
        ...
        if (type_item.icon) {
            setImagePreview(type_item.icon);
        }
    }, [type_item.icon]);
    ...
    const handleSubmit = (e) => {
        ...
        post(route("admin.ad_types.update", type_item.id));
    };
    ...
    return (
        <Authenticated
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Ad Type/Edit</h2>}
        >
            <Head title="Ad Type Edit" />
                        ...
                        <div className='row'>
                            <div className='col-lg-6'>
                                <div className="d-flex flex-column">
                                    <h4 className="page-title"> Edit Ad Type</h4>

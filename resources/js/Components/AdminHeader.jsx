            ...
            <div className="d-flex align-items-center logo-box justify-content-start">
                ...
                <Link href={route('admin.index')} className="logo">
                    ...
                    <div className="logo-lg">
                        <span className="light-logo"><img src="/assets/admin/images/logo-dark-text.png" className="w-100" alt="logo" /></span>
                        <span className="dark-logo"><img src="/assets/admin/images/logo-light-text.png" className="w-100" alt="logo" /></span>
                    </div>
                </Link>
            </div>
            {/* <!-- Header Navbar --> */}
                ...
                <div className="navbar-custom-menu r-side">
                    <ul className="nav navbar-nav">
                        ...
                        <li className="dropdown user user-menu">
                            <a href="#" className="dropdown-toggle p-0 text-dark hover-primary ms-md-30 ms-10"
                                data-bs-toggle="dropdown" title="User">
                                <span className="ps-30 d-md-inline-block d-none">Hello,</span> <strong
                                    className="d-md-inline-block d-none">Alia</strong>
                                <img
                                    src="/assets/admin/images/avatar/avatar-11.png"
                                    className="user-image rounded-circle avatar bg-white mx-10" alt="User Image" />
                            </a>
                            <ul className="dropdown-menu animated flipInX">
                                <li className="user-body">
                                    <a className="dropdown-item" href="#"><i className="ti-user text-muted me-2"></i>
                                        Profile</a>
                                    <a className="dropdown-item" href="#"><i className="ti-wallet text-muted me-2"></i> My
                                        Wallet</a>
                                    <a className="dropdown-item" href="#"><i className="ti-settings text-muted me-2"></i>
                                        Settings</a>

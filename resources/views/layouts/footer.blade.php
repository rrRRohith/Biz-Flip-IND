<div class=''
    style="background-image: url(https://res.cloudinary.com/rr6/image/upload/v1718973583/newsletterbg_qq5oxy.png);
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <form method="POST" action="{{ route('subscribe.store') }}" id="subscribeForm" data-reset="true"
                    class="ajax">
                    @csrf
                    <div class="input-group mb-0">
                        <input name="email_id" form="subscribeForm" type="text"
                            class="form-control shadow-none rounded-1 border-gray" placeholder="Your email address" />
                        <div class="input-group-append">
                            <button data-default="Subscribe" form="subscribeForm"
                                class="btn btn-dark rounded-1 continue-btn border-bottom-2 shadow-none btn-lg fs-6">Subscribe</button>
                        </div>
                    </div>
                </form>
            </div>
...
<footer class='bg-white border-top border border-light border-bottom-0'>
    <div class="container py-3">
        <p class="m-auto text-center">© 2024 Designed and developed by <a
                ...
                target="_blank">INDigital Group</a>, All Rights Reserved</p>
    </div>
</footer>

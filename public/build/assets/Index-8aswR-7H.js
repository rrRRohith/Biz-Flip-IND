import{r as d,j as t,Y as u,y as p,b as N}from"./app-b61ggBVK.js";import{A as g}from"./AdminAuthenticated-D6-pV21W.js";import{M as f}from"./ModalPopup-C0Ef4DCV.js";import"./index-B1IIQBEw.js";import"./AdminSidebar-Jt8wJB0G.js";import"./objectWithoutPropertiesLoose-DgWvQqX6.js";import"./ToastNotification-BPLhBA2Y.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-8NOZbEwi.js";function M({contactMsgList:r,auth:l,success:n=null,error:c=null}){const i=e=>{window.confirm("Are you sure you want to delete this Inquiry?")&&p.delete(route("admin.contact_delete",e.id))},[o,a]=d.useState(!1),[h,x]=d.useState(null),m=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.contact_show",e.id)),b=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

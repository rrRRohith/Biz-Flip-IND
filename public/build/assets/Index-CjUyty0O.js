import{r as d,j as t,Y as b,y as u,b as N}from"./app-DEFvwcdl.js";import{A as g}from"./AdminAuthenticated-BP6FwpnW.js";import{M as y}from"./ModalPopup-BNHqrRZI.js";import"./PermissionAllow-B7s74L2E.js";import"./AdminSidebar-DBU5ZcO1.js";import"./useMergedRefs-B2_9xDH_.js";import"./extends-CCbyfPlC.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./ToastNotification-CN4koItJ.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-DR1INU4b.js";function P({Leads:r,auth:n,success:l=null,error:i=null}){console.log(r);const o=e=>{window.confirm("Are you sure you want to delete this Leads?")&&u.delete(route("admin.propery_lead_delete",e.id))},[c,a]=d.useState(!1),[h,m]=d.useState(null),x=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.propery_lead_show",e.id)),p=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

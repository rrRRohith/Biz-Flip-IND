import{r as d,j as t,Y as b,y as u,b as N}from"./app-DgcCZBWy.js";import{A as g}from"./AdminAuthenticated-j6vvldw9.js";import{M as y}from"./ModalPopup-q5LxplZW.js";import"./PermissionAllow-B757jAZE.js";import"./AdminSidebar-C8NNYMIP.js";import"./useMergedRefs-CnoNJX2P.js";import"./extends-CCbyfPlC.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./ToastNotification-PXY2H3mA.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-B07UDkQ7.js";function P({Leads:r,auth:n,success:l=null,error:i=null}){console.log(r);const o=e=>{window.confirm("Are you sure you want to delete this Leads?")&&u.delete(route("admin.propery_lead_delete",e.id))},[c,a]=d.useState(!1),[h,m]=d.useState(null),x=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.propery_lead_show",e.id)),p=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

import{r as d,j as t,Y as b,y as u,b as N}from"./app-Bt0m9nwf.js";import{A as g}from"./AdminAuthenticated-DMuTscZI.js";import{M as y}from"./ModalPopup-Ch3lDOoX.js";import"./Dropdown--3mGBi1U.js";import"./AdminSidebar-BMjG_Soo.js";import"./index-CaGrVHXr.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./setPrototypeOf-DgZC2w_0.js";import"./ThemeProvider-D8R-b6vJ.js";function C({Leads:r,auth:n,success:l=null,error:i=null}){console.log(r);const c=e=>{window.confirm("Are you sure you want to delete this Leads?")&&u.delete(route("admin.propery_lead_delete",e.id))},[o,a]=d.useState(!1),[h,x]=d.useState(null),m=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.propery_lead_show",e.id)),p=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

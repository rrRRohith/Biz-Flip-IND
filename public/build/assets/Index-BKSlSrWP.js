import{r as d,j as t,Y as b,y as u,b as N}from"./app-BNxhFZPN.js";import{A as g}from"./AdminAuthenticated-BNTQeCzo.js";import{M as y}from"./ModalPopup-DOejYFXg.js";import"./Dropdown-B2Y32odu.js";import"./AdminSidebar-DUpkTSpT.js";import"./index-FEq80d4h.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./setPrototypeOf-DgZC2w_0.js";function _({Leads:r,auth:n,success:l=null,error:i=null}){console.log(r);const c=e=>{window.confirm("Are you sure you want to delete this Leads?")&&u.delete(route("admin.propery_lead_delete",e.id))},[o,a]=d.useState(!1),[h,x]=d.useState(null),m=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.propery_lead_show",e.id)),p=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

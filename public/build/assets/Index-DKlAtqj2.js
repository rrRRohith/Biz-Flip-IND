import{r as d,j as t,Y as u,y as p,b as N}from"./app-BNxhFZPN.js";import{A as g}from"./AdminAuthenticated-BNTQeCzo.js";import{M as f}from"./ModalPopup-DOejYFXg.js";import"./Dropdown-B2Y32odu.js";import"./AdminSidebar-DUpkTSpT.js";import"./index-FEq80d4h.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./setPrototypeOf-DgZC2w_0.js";function E({contactMsgList:r,auth:l,success:n=null,error:c=null}){const i=e=>{window.confirm("Are you sure you want to delete this Inquiry?")&&p.delete(route("admin.contact_delete",e.id))},[o,a]=d.useState(!1),[h,x]=d.useState(null),m=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.contact_show",e.id)),b=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

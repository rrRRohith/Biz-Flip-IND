import{r as d,j as t,Y as u,y as N,b as p}from"./app-fOjyYbMD.js";import{A as g}from"./AdminAuthenticated-BsX_IIvZ.js";import{M as f}from"./ModalPopup-cIroODc7.js";import"./index-CCmD6mTK.js";import"./AdminSidebar-Dnug4d1-.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-Cm3v6UGA.js";function A({contactMsgList:r,auth:l,success:n=null,error:c=null}){const i=e=>{window.confirm("Are you sure you want to delete this Inquiry?")&&N.delete(route("admin.contact_delete",e.id))},[o,a]=d.useState(!1),[h,x]=d.useState(null),m=()=>a(!1),j=async e=>{try{const s=await p.get(route("admin.contact_show",e.id)),b=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

import{j as s,r as u,W as w}from"./app-BDFA7kHC.js";import{P as c}from"./index-ByIaxJa0.js";import{S as y}from"./slick-theme-S6mFoURQ.js";import{S as h,T as P}from"./StatusBtn-VvRBj3r0.js";import{D as T}from"./DynamicSelect-C9RUCt4p.js";import"./listen-B0dR9xdZ.js";import"./TabPane-MGgGF9M8.js";import"./Anchor-C7u-wxA0.js";import"./extends-CCbyfPlC.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./Fade-Bg678BVI.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./react-select.esm-B7lCv496.js";import"./Select-49a62830.esm-jUMKTUGN.js";import"./objectSpread2-BZX5QY3a.js";import"./defineProperty-DpFVb8oi.js";import"./extends-DM2IsgWP.js";import"./emotion-react.browser.esm-D1beDQ3w.js";import"./hoist-non-react-statics.cjs-Dc24XJvx.js";function C({images:t=[],slidesToShow:p=4,dots:l=!1,arrow:n=!1}){const e={dots:l,infinite:!0,speed:500,slidesToShow:p,slidesToScroll:1,autoplay:!0,autoplaySpeed:2e3,arrows:n};return s.jsx(s.Fragment,{children:t.length?s.jsx(y,{...e,children:t.map((m,i)=>s.jsx("div",{className:"item",children:s.jsxs("div",{className:"pe-20",children:[s.jsx("img",{role:"button",src:window.getImageAsset(m),className:"img-fluid rounded15 mb-15",alt:window.getImageAsset(m),onError:a=>{a.target.onerror=null,a.target.src="/assets/admin/images/noimage.webp"}}),s.jsx("h6",{})]})},i))}):s.jsx("div",{children:"No images available"})})}const D=({collection:t,handleClose:p,onSubmit:l})=>{const[n,e]=u.useState(!1),[m,i]=u.useState(t.status),{data:a,setData:o,post:x,errors:_,reset:$}=w({status:t.status||"0",_method:"PUT"}),j=t.images||[],b=[{title:"Details",content:t.description+"<br>"},{title:"More Information",content:`<table class="table">
                                                    <tr>
                                                        <th>
                                                        Addess
                                                        </th>

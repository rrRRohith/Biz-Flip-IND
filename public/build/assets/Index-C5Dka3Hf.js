import{r as d,j as t,Y as u,y as p,b as N}from"./app-Ce4nVPSv.js";import{A as g}from"./AdminAuthenticated-DFE4wL38.js";import{M as f}from"./ModalPopup-DJLZWl8T.js";import"./Dropdown-BaINlLOw.js";import"./AdminSidebar-C_IBhiI5.js";import"./ToastNotification-Cst6kWz9.js";import"./index-DGJWvmkl.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./setPrototypeOf-DgZC2w_0.js";import"./ThemeProvider-BZdLA0m-.js";function _({contactMsgList:r,auth:l,success:n=null,error:c=null}){const i=e=>{window.confirm("Are you sure you want to delete this Inquiry?")&&p.delete(route("admin.contact_delete",e.id))},[o,a]=d.useState(!1),[h,m]=d.useState(null),x=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.contact_show",e.id)),b=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

import{r as d,j as t,Y as p,y as u,b as N}from"./app-DgcCZBWy.js";import{A as g}from"./AdminAuthenticated-j6vvldw9.js";import{M as f}from"./ModalPopup-q5LxplZW.js";import"./PermissionAllow-B757jAZE.js";import"./AdminSidebar-C8NNYMIP.js";import"./useMergedRefs-CnoNJX2P.js";import"./extends-CCbyfPlC.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./ToastNotification-PXY2H3mA.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-B07UDkQ7.js";function k({contactMsgList:r,auth:l,success:n=null,error:c=null}){const i=e=>{window.confirm("Are you sure you want to delete this Inquiry?")&&u.delete(route("admin.contact_delete",e.id))},[o,a]=d.useState(!1),[h,m]=d.useState(null),x=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.contact_show",e.id)),b=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

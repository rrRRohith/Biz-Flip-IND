import{r as d,j as t,Y as u,y as p,b as N}from"./app-Bt0m9nwf.js";import{A as g}from"./AdminAuthenticated-DMuTscZI.js";import{M as f}from"./ModalPopup-Ch3lDOoX.js";import"./Dropdown--3mGBi1U.js";import"./AdminSidebar-BMjG_Soo.js";import"./index-CaGrVHXr.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./setPrototypeOf-DgZC2w_0.js";import"./ThemeProvider-D8R-b6vJ.js";function M({contactMsgList:r,auth:l,success:n=null,error:c=null}){const i=e=>{window.confirm("Are you sure you want to delete this Inquiry?")&&p.delete(route("admin.contact_delete",e.id))},[o,a]=d.useState(!1),[h,x]=d.useState(null),m=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.contact_show",e.id)),b=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>

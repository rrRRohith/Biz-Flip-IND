import{j as s,r as u,W as w}from"./app-BLep4a_v.js";import{P as c}from"./index-YoWyG7So.js";import{S as y}from"./slick-theme-D91F1gy7.js";import{S as h,T as P}from"./StatusBtn-Bz87hL1p.js";import{D as T}from"./DynamicSelect-B6XEIOmE.js";import"./listen-bVhbO5mt.js";import"./TabPane-D2aZF-BK.js";import"./Anchor-Djf5sm_B.js";import"./extends-CCbyfPlC.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./Fade-DuAq4uZE.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./react-select.esm-DoLQJpXZ.js";import"./Select-49a62830.esm-DGV6mq4z.js";import"./objectSpread2-BZX5QY3a.js";import"./defineProperty-DpFVb8oi.js";import"./extends-DM2IsgWP.js";import"./emotion-react.browser.esm-Cd21aDf9.js";import"./hoist-non-react-statics.cjs-BNmgfxmt.js";function C({images:t=[],slidesToShow:p=4,dots:l=!1,arrow:n=!1}){const e={dots:l,infinite:!0,speed:500,slidesToShow:p,slidesToScroll:1,autoplay:!0,autoplaySpeed:2e3,arrows:n};return s.jsx(s.Fragment,{children:t.length?s.jsx(y,{...e,children:t.map((m,i)=>s.jsx("div",{className:"item",children:s.jsxs("div",{className:"pe-20",children:[s.jsx("img",{role:"button",src:window.getImageAsset(m),className:"img-fluid rounded15 mb-15",alt:window.getImageAsset(m),onError:a=>{a.target.onerror=null,a.target.src="/assets/admin/images/noimage.webp"}}),s.jsx("h6",{})]})},i))}):s.jsx("div",{children:"No images available"})})}const D=({collection:t,handleClose:p,onSubmit:l})=>{const[n,e]=u.useState(!1),[m,i]=u.useState(t.status),{data:a,setData:o,post:x,errors:_,reset:$}=w({status:t.status||"0",_method:"PUT"}),j=t.images||[],b=[{title:"Details",content:t.description+"<br>"},{title:"More Information",content:`<table class="table">
                                                    <tr>
                                                        <th>
                                                        Addess
                                                        </th>

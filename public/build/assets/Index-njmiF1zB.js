<<<<<<<< HEAD:public/build/assets/Index-R_Lwtp4G.js
import{r as i,j as t,Y as q,y as S,b as A}from"./app-BFziaLc8.js";import{S as P}from"./sweetalert2.all-BgiszN60.js";import{A as O}from"./AdminAuthenticated-R5d5aaAz.js";import{M as Q}from"./ModalPopup-C0qUYxxX.js";import{d as s}from"./index-gQXymU0R.js";/* empty css                                  */import{P as V}from"./PermissionAllow-BMd22zYm.js";import{P as R}from"./Pagination-MARkcdps.js";import"./Dropdown-BnhtuuKr.js";import"./AdminHeader-B2W2SGol.js";import"./Dropdown-uniGy3Ry.js";import"./listen-DZ-vge56.js";import"./useWindow-CVfyubcI.js";import"./Anchor-BOfA6n73.js";import"./extends-CCbyfPlC.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./index-DT0CiUab.js";import"./BootstrapModalManager-CmT5FPTN.js";import"./Fade-BEd4Hb9n.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-DDlfSZWB.js";import"./ToastNotification-Vk4cwDCt.js";import"./ReactToastify-CnXVQiE0.js";import"./Modal-B6dkGqN9.js";import"./interopRequireDefault-BbjLfwJi.js";import"./extends-CJoT7KlQ.js";import"./defineProperty-C77ibxUe.js";import"./emotion-react.browser.esm-Bv0pYBTZ.js";import"./hoist-non-react-statics.cjs-C-IiTMnH.js";import"./objectWithoutPropertiesLoose-DN910g8V.js";function Ct({contactLeads:n,adLeads:h,auth:x,success:f=null,error:y=null}){const[l,m]=i.useState(1),[c,p]=i.useState(""),[a,g]=i.useState(n.data),[B,E]=i.useState(h.data),[o,_]=i.useState("ContactLeads"),N=(r,e)=>{m(e),window.scrollTo(0,0)},w=r=>{const e=r.target.value;p(e);let d;o==="ContactLeads"?(d=n.data.filter(b=>b.title.toLowerCase().includes(e.toLowerCase())),g(d)):o==="AdLeads"&&(d=pendingAdsList.data.filter(b=>b.title.toLowerCase().includes(e.toLowerCase())),E(d)),m(1)},T=(()=>{if(c.length>0){if(o==="ContactLeads")return a;if(o==="AdLeads")return B}else{if(o==="ContactLeads")return n.data;if(o==="AdLeads")return pendingAdsList.data}})(),C=(l-1)*5,v=l*5,M=r=>{P.fire({title:"Are you sure you want to delete this Leads?",text:" Once deleted, it cannot be recovered.",icon:"warning",showCancelButton:!0,confirmButtonColor:"#d33",cancelButtonColor:"#3085d6",confirmButtonText:"Yes, delete it!"}).then(e=>{e.isConfirmed&&S.delete(route("admin.propery_lead_delete",r.id))})},I=r=>{P.fire({title:"Are you sure you want to delete this Inquiry?",text:" Once deleted, it cannot be recovered.",icon:"warning",showCancelButton:!0,confirmButtonColor:"#d33",cancelButtonColor:"#3085d6",confirmButtonText:"Yes, delete it!"}).then(e=>{e.isConfirmed&&S.delete(route("admin.contact_delete",r.id))})},[k,j]=i.useState(!1),[D,L]=i.useState(null),K=()=>j(!1),F=async r=>{try{const e=await A.get(route("admin.propery_lead_show",r.id)),d=`   <table className="table fw-700">
========
import{r as i,j as t,Y as q,y as S,b as A}from"./app-BFbjwEJ5.js";import{S as P}from"./sweetalert2.all-FHdFvT5z.js";import{A as O}from"./AdminAuthenticated-CtE91xaw.js";import{M as Q}from"./ModalPopup-BAeh73Vt.js";import{d as s}from"./index-MWeNFxc7.js";/* empty css                                  */import{P as V}from"./PermissionAllow-Cjtda5l-.js";import{P as R}from"./Pagination-QHtqD6FW.js";import"./Dropdown-CoxfjVNg.js";import"./AdminHeader-CUD-xda_.js";import"./Dropdown-CW1-Y9pG.js";import"./listen-CHQIrvYw.js";import"./useWindow-Bj85vBoX.js";import"./Anchor-BW_S9bV6.js";import"./extends-CCbyfPlC.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./index-8_Tsm8-z.js";import"./BootstrapModalManager-DMFdf33D.js";import"./Fade-BsYwFgum.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-tZUvsfOW.js";import"./ToastNotification-BOPxyPx_.js";import"./ReactToastify-CVUvdQIh.js";import"./Modal-q3BmkTpm.js";import"./interopRequireDefault-BbjLfwJi.js";import"./extends-CJoT7KlQ.js";import"./defineProperty-C77ibxUe.js";import"./emotion-react.browser.esm-DbpBUp3P.js";import"./hoist-non-react-statics.cjs-DXuNQ-pp.js";import"./objectWithoutPropertiesLoose-DN910g8V.js";function Ct({contactLeads:n,adLeads:h,auth:x,success:f=null,error:y=null}){const[l,m]=i.useState(1),[c,p]=i.useState(""),[a,g]=i.useState(n.data),[B,E]=i.useState(h.data),[o,_]=i.useState("ContactLeads"),N=(r,e)=>{m(e),window.scrollTo(0,0)},w=r=>{const e=r.target.value;p(e);let d;o==="ContactLeads"?(d=n.data.filter(b=>b.title.toLowerCase().includes(e.toLowerCase())),g(d)):o==="AdLeads"&&(d=pendingAdsList.data.filter(b=>b.title.toLowerCase().includes(e.toLowerCase())),E(d)),m(1)},T=(()=>{if(c.length>0){if(o==="ContactLeads")return a;if(o==="AdLeads")return B}else{if(o==="ContactLeads")return n.data;if(o==="AdLeads")return pendingAdsList.data}})(),C=(l-1)*5,v=l*5,M=r=>{P.fire({title:"Are you sure you want to delete this Leads?",text:" Once deleted, it cannot be recovered.",icon:"warning",showCancelButton:!0,confirmButtonColor:"#d33",cancelButtonColor:"#3085d6",confirmButtonText:"Yes, delete it!"}).then(e=>{e.isConfirmed&&S.delete(route("admin.propery_lead_delete",r.id))})},I=r=>{P.fire({title:"Are you sure you want to delete this Inquiry?",text:" Once deleted, it cannot be recovered.",icon:"warning",showCancelButton:!0,confirmButtonColor:"#d33",cancelButtonColor:"#3085d6",confirmButtonText:"Yes, delete it!"}).then(e=>{e.isConfirmed&&S.delete(route("admin.contact_delete",r.id))})},[k,j]=i.useState(!1),[D,L]=i.useState(null),K=()=>j(!1),F=async r=>{try{const e=await A.get(route("admin.propery_lead_show",r.id)),d=`   <table className="table fw-700">
>>>>>>>> 8a0a76ae1116db8dead3c7caf94f52c29dc22f8f:public/build/assets/Index-njmiF1zB.js
                                    <tbody>
                                    <tr>

import{j as s,r as u,W as w}from"./app-DQNkgWdZ.js";import{P as c}from"./index-DPs_KfQ3.js";import{S as y}from"./slick-theme-DUodIcfG.js";import{S as h,T as P}from"./StatusBtn-eYZJ_jgd.js";import{D as T}from"./DynamicSelect-cZ7UEqgD.js";import"./Fade-C51PzYCI.js";import"./objectWithoutPropertiesLoose-DXrfETLX.js";import"./inheritsLoose-1HkgTRWY.js";import"./setPrototypeOf-DgZC2w_0.js";import"./TabPane-C9mDERBi.js";import"./Anchor-CKIlv3KC.js";import"./extends-CCbyfPlC.js";import"./react-select.esm-BaaNaf8X.js";import"./Select-49a62830.esm-C1qB4LVT.js";import"./objectSpread2-BZX5QY3a.js";import"./defineProperty-DpFVb8oi.js";import"./extends-DM2IsgWP.js";import"./emotion-react.browser.esm-CWUohC2S.js";import"./hoist-non-react-statics.cjs-C-oITpAa.js";function C({images:e=[],slidesToShow:p=4,dots:l=!1,arrow:n=!1}){const t={dots:l,infinite:!0,speed:500,slidesToShow:p,slidesToScroll:1,autoplay:!0,autoplaySpeed:2e3,arrows:n};return s.jsx(s.Fragment,{children:e.length?s.jsx(y,{...t,children:e.map((m,i)=>s.jsx("div",{className:"item",children:s.jsxs("div",{className:"pe-20",children:[s.jsx("img",{role:"button",src:window.getImageAsset(m),className:"img-fluid rounded15 mb-15",alt:window.getImageAsset(m),onError:a=>{a.target.onerror=null,a.target.src="/assets/admin/images/noimage.webp"}}),s.jsx("h6",{})]})},i))}):s.jsx("div",{children:"No images available"})})}const D=({collection:e,handleClose:p,onSubmit:l})=>{const[n,t]=u.useState(!1),[m,i]=u.useState(e.status),{data:a,setData:o,post:x,errors:_,reset:$}=w({status:e.status||"0",_method:"PUT"}),j=e.images||[],b=[{title:"Details",content:e.description+"<br>"},{title:"More Information",content:`<table class="table">
                                                    <tr>
                                                        <th>
                                                        Addess
                                                        </th>

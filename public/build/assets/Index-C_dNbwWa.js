import{r as d,j as t,Y as b,y as u,b as N}from"./app-b61ggBVK.js";import{A as g}from"./AdminAuthenticated-D6-pV21W.js";import{M as y}from"./ModalPopup-C0Ef4DCV.js";import"./index-B1IIQBEw.js";import"./AdminSidebar-Jt8wJB0G.js";import"./objectWithoutPropertiesLoose-DgWvQqX6.js";import"./ToastNotification-BPLhBA2Y.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-8NOZbEwi.js";function C({Leads:r,auth:n,success:l=null,error:i=null}){console.log(r);const c=e=>{window.confirm("Are you sure you want to delete this Leads?")&&u.delete(route("admin.propery_lead_delete",e.id))},[o,a]=d.useState(!1),[h,x]=d.useState(null),m=()=>a(!1),j=async e=>{try{const s=await N.get(route("admin.propery_lead_show",e.id)),p=`   <table class="table fw-700">
                                    <tbody>
                                    <tr>
